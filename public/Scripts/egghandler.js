...
function updateEggValueBonus() {
    ...
    eggValueBonus = data.research[1].gt(0) ? eggValueBonus.times((D(0.25).times(data.research[1])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[3].gt(0) ? eggValueBonus.times((D(0.25).times(data.research[3])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[4].gt(0) ? eggValueBonus.times((Decimal.dTwo.times(data.research[4]))) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[6].gt(0) ? eggValueBonus.times((D(3).times(data.research[6]))) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[8].gt(0) ? eggValueBonus.times((D(0.25).times(data.research[8])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[10].gt(0) ? eggValueBonus.times((D(0.15).times(data.research[10])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[11].gt(0) ? eggValueBonus.times((D(0.15).times(data.research[11])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[12].gt(0) ? eggValueBonus.times((Decimal.dTwo.times(data.research[12]))) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[14].gt(0) ? eggValueBonus.times((D(0.1).times(data.research[14])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[17].gt(0) ? eggValueBonus.times((Decimal.dTwo.times(data.research[17]))) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[18].gt(0) ? eggValueBonus.times((D(0.25).times(data.research[18])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[20].gt(0) ? eggValueBonus.times((D(0.25).times(data.research[20])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[21].gt(0) ? eggValueBonus.times((D(0.1).times(data.research[21])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[22].gt(0) ? eggValueBonus.times((Decimal.dTen.times(data.research[22]))) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[23].gt(0) ? eggValueBonus.times((D(0.05).times(data.research[23])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[24].gt(0) ? eggValueBonus.times((D(0.01).times(data.research[24])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[25].gt(0) ? eggValueBonus.times((D(.01).times(data.research[25])).add(1)) : eggValueBonus.times(Decimal.dOne)
    eggValueBonus = data.research[26].gt(0) ? eggValueBonus.times((Decimal.dTen.times(data.research[26]))) : eggValueBonus.times(Decimal.dOne)

    eggValueBonus = data.epicResearch[5].gt(0) ? eggValueBonus.times((D(0.05).times(data.epicResearch[5])).add(1)) : eggValueBonus.times(Decimal.dOne)
...
function updateIntHatch() {
    ...
    chickenGain = chickenGain.times((D(0.05).times(data.epicResearch[0])).add(1))
...
function updateLayRate() {
    ...
    layRate = data.research[0].gt(0) ? layRate.times((D(0.1).times(data.research[0])).add(1)) : layRate.times(Decimal.dOne)
    layRate = data.research[7].gt(0) ? layRate.times((D(0.05).times(data.research[7])).add(1)) : layRate.times(Decimal.dOne)
    layRate = data.research[10].gt(0) ? layRate.times((D(0.15).times(data.research[10])).add(1)) : layRate.times(Decimal.dOne)
    layRate = data.research[16].gt(0) ? layRate.times((D(0.1).times(data.research[16])).add(1)) : layRate.times(Decimal.dOne)
    layRate = data.research[27].gt(0) ? layRate.times((D(0.1).times(data.research[27])).add(1)) : layRate.times(Decimal.dOne)
    layRate = data.epicResearch[4].gt(0) ? layRate.times((D(0.5).times(data.epicResearch[4])).add(1)) : layRate.times(Decimal.dOne)
