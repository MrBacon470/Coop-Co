function updateHTML() {
    ...
    const previousEggUnlockReq = eggData[data.currentEgg].unlockReq
    const currentEggUnlockReq = eggData[data.currentEgg].unlockReq
    const eggUnlockProgress = data.money.div(previousEggUnlockReq).log10().div(currentEggUnlockReq.div(previousEggUnlockReq).log10())
