const achievementObjs = [
    ...
    { name: 'Contracted', description: 'Completed a Contract', img: 'Imgs/greencheck.png'},
    { name: 'Contractual', description: 'Complete 10 Contracts', img: 'Imgs/greencheck.png'},
    { name: 'Contractful', description: 'Complete 100 Contracts', img: 'Imgs/greencheck.png'},
    { name: 'Contractor', description: 'Complete a Thousand Contracts', img: 'Imgs/greencheck.png'},
    ...
    { name: 'Planetary I', description: 'Unlock the 1st Planet', img: `Imgs/planet1.png`},
    { name: 'Planetary II', description: 'Unlock the 2nd Planet', img: `Imgs/planet2.png`},
    { name: 'Planetary III', description: 'Unlock the 3rd Planet', img: `Imgs/planet3.png`},
    { name: 'Planetary IV', description: 'Unlock the 4th Planet', img: `Imgs/planet4.png`},
    { name: 'Planetary V', description: 'Unlock the 5th Planet', img: `Imgs/planet5.png`},
    { name: 'Planetary VI', description: 'Unlock the 6th Planet', img: `Imgs/planet6.png`},
